        ...
        <div class="ibox">
            <div class="ibox-heading p-h-xs">
                <div class="ibox-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2 class="text-left">Popup Add</h2>
                        </div>
            ...
            <div class="ibox-content">
                <div class="row">
                    <div class="col-md-7">
                        <form action="{{ route('popups.store', ['sub_domain' => session()->get('sub_domain')]) }}" class="form-horizontal grey-bg" method="post">
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <input type="text" id="popupname" required minlength="4" name="popupname" class="form-control" value=""/>
                                        </div>
                                        <div class="clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input type="number" id="width" name="width" max="1200" min="100" required class="wid-80 form-control" value=""/>
                                                </div>
                                                <div class="pull-left"><label class="control-label"> px wide by </label></div>
                                            </div>
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input type="number" id="height" name="height" max="800" min="100" required class="form-control wid-80" value=""/>
                                                </div>
                                                <div class="pull-left"><label class="control-label">px high</label> </div>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="exit_intelligent" name="exit_method" value="Intelligent" checked/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="exit_redir" name="exit_method" value="Redir"/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="exit_standered" name="exit_method" value="standered"/>
                                                </div>
                                                <div class="pull-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="closable_no" name="closable" value="0"/>
                                                </div>
                                                <div class="pull-left">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <input type="number" max="99" id="cookie_duration" name="cookie_duration" class="form-control" value=""/>
                                            </div>
                                            <div class="pull-left">
                            ...
                            <div class="form-group">
                                <textarea id="content-editor" name="popup_contents"></textarea>
                                <div class="row text-right">
