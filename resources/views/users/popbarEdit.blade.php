        ...
        <div class="ibox">
            <div class="ibox-heading p-h-xs">
                <div class="ibox-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2 class="text-left">Edit Banner</h2>
                        </div>
            ...
            <div class="ibox-content">
                <div class="row">
                    <div class="col-md-7">
                        <form action="{{ route('popbars.update', ['popbar' => $popbar->id, 'sub_domain' => session()->get('sub_domain')]) }}" class="form-horizontal grey-bg" method="post">
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <input type="text" id="bar_name" required minlength="4" name="bar_name" class="form-control" value="{{ $popbar->bar_name  }}"/>
                                        </div>
                                        <div class="clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="position_top" name="position" value="1" {{ ($popbar->position != '0') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="position_bottom" name="position" value="0" {{ ($popbar->position == '0') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input type="number" id="height" name="height" max="200" min="10" required class="form-control wid-80" value="{{ $popbar->height  }}"/>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="timing_onload" name="timing" value="Onload" {{ ($popbar->timing == 'Onload') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="timing_after" name="timing" value="After" {{ ($popbar->timing != 'Onload') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input type="number" id="delay_timing" name="delay_timing" class="wid-80 form-control" value="{{ $popbar->delay_timinig }}"/>
                                                </div>
                                                <div class="pull-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="shadow_yes" name="shadow" value="1" {{ ($popbar->shadow != '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="shadow_no" name="shadow" value="2" {{ ($popbar->shadow == '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="closable_yes" name="closable" value="1" {{ ($popbar->closable != '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="closable_no" name="closable" value="2" {{ ($popbar->closable == '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <input type="text" id="colorSelector" name="button_color" maxlength="6" minlength="6" class="form-control" value="{{ $popbar->button_color  }}"/>
                                        </div>
                                    </div>
                                    <div class="m-t-xs text-left rtooltip">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="spacer_yes" name="spacer" value="1" {{ ($popbar->spacer != '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="spacer_no" name="spacer" value="2" {{ ($popbar->spacer == '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="transparent_background_yes" name="transparent_background" value="1" {{ ($popbar->transparent_background != '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                                            ...
                                            <div class="pull-left">
                                                <div class="pull-left">
                                                    <input class="form-control" type="radio" id="transparent_background_no" name="transparent_background" value="2" {{ ($popbar->transparent_background == '2') ? 'checked' : '' }}/>
                                                </div>
                                                <div class="pull-left">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-xs-10">
                                        <div class="row">
                                            <input type="text" id="url" name="url" class="form-control" value="{{ $popbar->url  }}"/>
                                        </div>
                                        <div class="clearfix">
