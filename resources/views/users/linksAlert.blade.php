		...
		<div class="ibox">
			<div class="ibox-heading p-h-xs">
				<div class="ibox-title">
					<div class="row">
						<div class="col-sm-5">
							<h2 class="text-left">Link Alerts for "{{ $link->tracking_link }}"</h2>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 text-left">
									<div class="radio checkbox-primary">
										<input type="radio" class="radio" id="status_yes" name="status"{{ $linkStatus == '1' ? ' checked' : '' }}/>
										<label class="radio-inline" for="status_yes">Yes</label>
									</div>
									<div class="radio checkbox-primary">
										<input type="radio" class="radio" id="status_no" name="status"{{ $linkStatus == '0' ? ' checked' : '' }}/>
