		...
		<div class="ibox">
			<div class="ibox-heading p-h-xs">
				<div class="ibox-title">
					<div class="row">
						<div class="col-sm-5">
							<h2 class="font-bold text-left">Add Rotator</h2>
						</div>
			...
			<div class="ibox-content">
				<div class="row">
					<div class="col-md-8 create-form">
						<form action="{{ route('rotators.store', ['sub_domain' => session()->get('sub_domain')]) }}" class="form-horizontal" method="post" id="rotatorFrm"
						      name="rotatorFrm">
							<div class="grey-bg">
										...
										<div class="row">
											...
											<div class="col-md-4 no-padding-left">
												<div class="track-link-sept">
													<input type="text" id="rotator_link" name="rotator_link" class="form-control" maxlength="255" minlength="4" required/>
												</div>
											</div>
										</div>
								...
								<div class="form-group{{ $errors->has('rotator_name') ? ' has-error' : '' }}">
									<label class="col-md-3 col-sm-2 control-label text-left" for="rotator_name">Rotator Name:</label>
									<div class="col-sm-8 col-xs-10">
										<input type="text" id="rotator_name" name="rotator_name" maxlength="255" minlength="4" class="form-control"/>
									...
									<div class="col-sm-8 col-xs-10 text-left">
										<div class="radio checkbox-primary">
											...
											<input type="radio" value="1" id="rotator_mode_spill" name="rotator_mode" class="form-control"
											       onclick="displayRotatorMode(this.value)"/>
								...
								<div class="form-group m-t fn_rotator_det{{ $errors->has('rotator_mode') ? ' has-error' : '' }}">
									...
									<div class="col-sm-8 col-xs-10 text-left no-padding-left">
										<div class="radio checkbox-primary">
											...
											<input type="radio" value="2" id="on_finish_top" name="on_finish" class="form-control" checked/>
									...
									<div class="col-sm-8 col-xs-10 text-left">
										<div class="radio checkbox-primary">
											<input type="radio" value="1" id="cloak_rotator_yes" name="cloak_rotator" class="form-control"
											       onclick="displayCloakDetails(this.value)"/>
											...
											<input type="radio" value="0" id="cloak_rotator_no" name="cloak_rotator" class="form-control"
											       onclick="displayCloakDetails(this.value)" checked/>
								...
								<div class="form-group m-t">
									...
									<div class="col-sm-8 col-xs-10">
										<input type="url" id="backup_url" name="backup_url" maxlength="255" minlength="4" class="form-control" required/>
											...
											<div class="col-md-9 text-left">
												<div class="randomise-minblock clearfix">
													<div class="randomise-input pull-left">
														<input type="number" class="form-control" id="cookie_duration" name="cookie_duration" min="1" max="999"/>
													</div>
											...
											<div class="col-md-9 text-left">
												...
												<div class="m-t-md">
													<div class="checkbox checkbox-primary">
														<input type="checkbox" class="form-control" id="ignore_last_url" value="1" name="ignore_last_url" />
							...
							<div class="form-group m-t-lg col-md-offset-4">
								<button type="submit" class="btn btn-success">CREATE NEW ROTATOR</button>
