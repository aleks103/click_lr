		...
		<div class="ibox">
			<div class="ibox-heading p-h-xs">
				<div class="ibox-title">
					<div class="row">
						<div class="col-sm-5">
							<h2 class="font-bold text-left">Add Link</h2>
						</div>
			...
			<div class="ibox-content">
				<div class="row">
					<div class="col-md-8 create-form">
						<form action="{{ route('links.store', ['sub_domain' => session()->get('sub_domain')]) }}" class="form-horizontal" method="post" id="linkFrm" name="linkFrm">
							<div class="grey-bg">
								<div class="form-group{{ $errors->has('primary_url') ? ' has-error' : '' }}">
									...
									<div class="col-sm-8 col-xs-10">
										<input type="url" id="primary_url" name="primary_url" class="form-control" required/>
										...
										<div class="row">
											...
											<div class="col-md-4 no-padding-left">
												<div class="track-link-sept">
													<input type="text" id="tracking_link" name="tracking_link" class="form-control" maxlength="255" minlength="4" required/>
												</div>
											</div>
										</div>
								...
								<div class="form-group{{ $errors->has('link_name') ? ' has-error' : '' }}">
									...
									<div class="col-sm-8 col-xs-10">
										<input type="text" id="link_name" name="link_name" maxlength="255" minlength="4" class="form-control"/>
										...
										<div class="form-group{{ $errors->has('cloak_link') ? ' has-error' : '' }}">
											...
											<div class="col-md-9 text-left">
												<div class="radio checkbox-primary">
													<input type="radio" name="cloak_link" id="cloak_link_yes" onclick="displayCloakDetails(this.value)" value="Yes"/>
													<label class="control-label" for="cloak_link_yes">Yes</label>
												</div>
												<div class="radio checkbox-primary">
													<input type="radio" name="cloak_link" id="cloak_link_no" onclick="displayCloakDetails(this.value)" value="No" checked/>
										...
										<div class="form-group m-t-md fn_cloak_det{{ $errors->has('cloak_page_title') ? ' has-error' : '' }}" style="display: none">
											<div class="row">
												...
												<div class="col-md-8 text-left">
													<input type="text" id="cloak_page_title" name="cloak_page_title" class="form-control"/>
								...
								<div id="traffic_cost_div" class="panel panel-info">
									...
									<div class="panel-body">
										<div class="form-group{{ $errors->has('traffic_cost') ? ' has-error' : '' }}">
											...
											<div class="col-md-9 text-left">
												<input type="number" class="form-control" id="traffic_cost" name="traffic_cost"/>
								...
								<div id="geotargeting_div" class="panel panel-info">
									...
									<div class="panel-body">
										<div class="form-group{{ $errors->has('geo_targeting') ? ' has-error' : '' }}">
											...
											<div class="col-md-9 text-left">
												<div class="radio checkbox-primary">
													<input type="radio" name="geo_targeting" id="geo_targeting_all" onclick="displayCountries(this.value)" value="All" checked/>
													<label class="control-label" for="geo_targeting_all">All countries</label>
												</div>
												<div class="radio checkbox-primary">
													<input type="radio" name="geo_targeting" id="geo_targeting_apecified" onclick="displayCountries(this.value)" value="Specified"/>
										...
										<div class="form-group{{ $errors->has('geo_targeting_include_countries') ? ' has-error' : '' }}">
											...
											<div class="col-md-8 text-left">
												...
												<input type="hidden" id="geo_include" value=""/>
											</div>
											<div class="m-t-xs text-left rtooltip">
										...
										<div class="form-group{{ $errors->has('geo_targeting_exclude_countries') ? ' has-error' : '' }}">
											...
											<div class="col-md-8 text-left">
												...
												<input type="hidden" id="geo_exclude" value=""/>
											</div>
											<div class="m-t-xs text-left rtooltip">
										...
										<div class="form-group">
											...
											<div class="col-md-9 text-left">
												<input type="url" class="form-control" id="backup_url" name="backup_url" maxlength="255"
												       placeholder="http://www.example.com/search"/>
										...
										<div class="form-group">
											...
											<div class="col-md-9 text-left">
												...
												<div class="checkbox checkbox-primary text-muted">
													<input type="checkbox" name="tracking_link_visited" id="tracking_link_visited" value="Yes"/>
													<label for="tracking_link_visited" class="control-label">Apply if visitor has already clicked ANY tracking link with this
														Primary URL</label>
												</div>
								...
								<div id="pixel_code_div" class="panel panel-info">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-md-9 text-left">
												<textarea id="pixel_code" name="pixel_code" class="form-control" cols="10" rows="5"></textarea>
												...
												<div class="checkbox checkbox-primary text-muted">
													<input type="checkbox" name="create_dynamic_link" id="create_dynamic_link" onclick="generateDynamicCode()" value="Yes"/>
													<label for="create_dynamic_link" class="control-label">Create Dynamic Affiliate Link</label>
												</div>
										...
										<div class="form-group{{ $errors->has('detect_new_bots') ? ' has-error' : '' }}">
											...
											<div class="col-md-9 m-t-sm text-left">
												<div class="checkbox checkbox-primary">
													<input type="checkbox" name="detect_new_bots" id="detect_new_bots" value="Yes"/>
									...
									<div class="panel-body">
										<div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}">
											<div class="col-xs-12">
												...
												<textarea id="notes" name="notes" cols="10" rows="5" maxlength="255" class="form-control"></textarea>
							...
							<div class="form-group m-t-lg col-md-offset-4">
								<button type="submit" class="btn btn-success">CREATE NEW LINK</button>
